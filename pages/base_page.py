...
class BasePage:
    ...
    def elements_are_present(self, locator, timeout=5):  # чтобы найти элемент который представлен на странице (не обязательно в поле видимости, можно в DOMе)...и чтобы не скроллить страницу
